...
keymap.set("n", "<leader>ss", "<cmd>mksession! ~/.vim/sessions/session.vim<CR>", { desc = "[S]ave [S]ession" })

-- Load session
keymap.set("n", "<leader>sl", "<cmd>source ~/.vim/sessions/session.vim<CR>", { desc = "[S]ession [L]oad" })
